...
namespace Alura.CoisasAFazer.Services.Handlers
{
    public class CadastraTarefaHandler
    {
        ...
        public CadastraTarefaHandler(IRepositorioTarefas repositorio = null, ILogger<CadastraTarefaHandler> logger = null)
        {
            _repo = repositorio ?? new RepositorioTarefa();
            _logger = logger ?? new LoggerFactory().CreateLogger<CadastraTarefaHandler>();
        }
